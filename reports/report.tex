...
\begin{itemize}
\item \verb-void put_n_symbols_to_array_with_counter(char* array,-

\begin{flushright}
\verb- int n, char symbol, int *index)-
\end{flushright}
...
Возвращаемое занчение имеет тип \textbf{\textit{void}}
\end{itemize}

\begin{itemize}
\item \verb-void put_result_to_array(char* array, int first_number,-

\begin{flushright}
\verb- int second_number)-
\end{flushright}
...
\item \verb-void determine_file_proportions(char* input_file_name,-

\begin{flushright}
\verb-int* number_of_lines, int* max_length_of_line)-
\end{flushright}
...
\begin{itemize}
\item \verb-void symmetrize_line(char* final_line, char* initial_line,-

\begin{flushright}
\verb- int max_length_of_line)-
\end{flushright}
