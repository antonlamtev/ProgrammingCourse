...
Эта функция осуществляет контролируемый ввод из консоли координат ферзя. Имеет два параметра типа \textit{\textbf{int*}} - две координаты ферзя. И один параметр типа \textit{\textbf{int}} - номер ферзя. Возвращает пустое значение.
\end{itemize}
\begin{itemize}
...
\item[Выходные данные:] \includegraphics[scale=1]{quotient.png}
\item[Результат:] Тест успешно пройден
...
\item[Входные данные:] 
\center{\includegraphics[scale=1]{lines_in.png}}

\item[Выходные данные:] 
\center{\includegraphics[scale=1]{lines_out.png}}
