...
//void Text::determine_file_proportions(char* input_file_name, int* number_of_lines, int* max_length_of_line)
//{
...
//void Text::symmetrize_line(char* final_line, char* initial_line, int max_length_of_line)
//{
